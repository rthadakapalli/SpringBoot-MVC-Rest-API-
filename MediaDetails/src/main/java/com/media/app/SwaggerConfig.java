...
public class SwaggerConfig {
	...
	// call swagger at http://localhost:9096/v2/api-docs and http://localhost:9096/swagger-ui.html#/
	
	/*@Bean
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.media.api"))//.apis(customRequestHandlers())
                .paths(regex("/movie.*"))
                .build()
                .apiInfo(metaData());
    }
	 ...
	 private ApiInfo metaData() {
	        ApiInfo apiInfo = new ApiInfo(
	                ...
	                "REST API for Media Store",
	                "1.0",
	                "Terms of service",
	                new Contact("Rohit Thadakapalli", "http://localhost:9096/v2/api-docs", "rohit.thadakapalli@gmail.com"),
